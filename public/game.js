...
function InventoryItem({item,active,setActive,slot}){let iName="";if(!item){item={};}else if(item.id!=0){iName=BlockIndex.blocks[item.id];}if(slot)return/*#__PURE__*/React.createElement("div",{className:"inventory-slot",id:`slot${slot}`},/*#__PURE__*/React.createElement("div",{className:"inventory-item-image"},iName&&iName.trim().length>0?/*#__PURE__*/React.createElement("img",{src:`assets/blocks/${iName}.png`,alt:"slotItem"}):/*#__PURE__*/React.createElement("div",{className:"inventory-item-image-empty"})),/*#__PURE__*/React.createElement("div",{className:"inventory-item-count"},item.count&&item.count>0?/*#__PURE__*/React.createElement("span",null,item.count):/*#__PURE__*/React.createElement("span",null)));else return/*#__PURE__*/React.createElement("div",{className:`inventory-item ${active.id==(item.id||0)?"glow":""}`,onClick:()=>setActive(item)},/*#__PURE__*/React.createElement("div",{className:"inventory-item-image"},iName&&iName.trim().length>0?/*#__PURE__*/React.createElement("img",{src:`assets/blocks/${iName}.png`,alt:"slotItem"}):/*#__PURE__*/React.createElement("div",{className:"inventory-item-image-empty"})),/*#__PURE__*/React.createElement("div",{className:"inventory-item-count"},item.count&&item.count>0?/*#__PURE__*/React.createElement("span",null,item.count):/*#__PURE__*/React.createElement("span",null)));}
