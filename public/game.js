...
function InventoryItem({item,active,setActive,slot}){if(!item){item={};}if(slot)return/*#__PURE__*/React.createElement("div",{className:"inventory-slot",id:`slot${slot}`},/*#__PURE__*/React.createElement("div",{className:"inventory-item-image"},item.img?/*#__PURE__*/React.createElement("img",{src:item.img,alt:"slotItem"}):/*#__PURE__*/React.createElement("div",{className:"inventory-item-image-empty"})),/*#__PURE__*/React.createElement("div",{className:"inventory-item-count"},item.count&&item.count>0?/*#__PURE__*/React.createElement("span",null,item.count):/*#__PURE__*/React.createElement("span",null)));else return/*#__PURE__*/React.createElement("div",{className:`inventory-item ${active.id==(item.id||0)?"glow":""}`,onClick:()=>setActive(item)},/*#__PURE__*/React.createElement("div",{className:"inventory-item-image"},item.img?/*#__PURE__*/React.createElement("img",{src:item.img,alt:"slotItem"}):/*#__PURE__*/React.createElement("div",{className:"inventory-item-image-empty"})),/*#__PURE__*/React.createElement("div",{className:"inventory-item-count"},item.count&&item.count>0?/*#__PURE__*/React.createElement("span",null,item.count):/*#__PURE__*/React.createElement("span",null)));}

function Inventory({inventory,profile}){if(!inventory||!profile){inventory=new Array(64).fill({id:0,count:0,img:""});profile={};}let[items,setItems]=react.exports.useState(inventory);let[active,setActive]=react.exports.useState({});return/*#__PURE__*/React.createElement("div",{className:"inventory"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile-name"},/*#__PURE__*/React.createElement("span",null,profile.name||"No Name"),/*#__PURE__*/React.createElement("span",null,"Lvl. ",profile.level||1)),/*#__PURE__*/React.createElement("div",{className:"inventory-profile-build"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile-top"},/*#__PURE__*/React.createElement(InventoryItem,{item:profile.leftHand,slot:1}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.head,slot:2}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.backPiece,slot:3}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.legs,slot:4})),/*#__PURE__*/React.createElement("div",{className:"inventory-profile-center"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile-center-container"},/*#__PURE__*/React.createElement(CharacterBuild,{profile:profile}))),/*#__PURE__*/React.createElement("div",{className:"inventory-profile-bottom"},/*#__PURE__*/React.createElement(InventoryItem,{item:profile.rightHand,slot:5}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.chest,slot:6}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.feet,slot:7})))),/*#__PURE__*/React.createElement("div",{className:"inventory-items"},/*#__PURE__*/React.createElement("ul",null,items.map((item,index)=>{return/*#__PURE__*/React.createElement("li",{key:index},/*#__PURE__*/React.createElement(InventoryItem,{item:item,active:active,setActive:setActive}));}))));}

const chatbox=/*#__PURE__*/React.createRef();const status=/*#__PURE__*/React.createRef();function App(){const[loginMode,setLoginMode]=React.useState(true);const[loggedIn,setLoggedIn]=React.useState(false);const[started,setStarted]=React.useState(false);const[username,setUsername]=React.useState("");const[selected,setSelected]=React.useState("");const[worlds,setWorlds]=React.useState([]);const[character,setCharacter]=React.useState([]);return/*#__PURE__*/React.createElement("div",{className:"main"},/*#__PURE__*/React.createElement("div",{className:`main-first ${started?"hidden":""}`},/*#__PURE__*/React.createElement("div",{className:`main-first-login ${loggedIn?"hidden":""}`},/*#__PURE__*/React.createElement("div",{className:`main-first-login-body`},/*#__PURE__*/React.createElement("h1",null,`${loginMode?"Login":"Register"}`),/*#__PURE__*/React.createElement("form",{onSubmit:e=>online.bind(this)(e,loginMode,setLoggedIn,setUsername)},/*#__PURE__*/React.createElement("label",{ref:status}),/*#__PURE__*/React.createElement("label",{htmlFor:"uname"},"Username"),/*#__PURE__*/React.createElement("input",{autoComplete:"false",className:"uname",type:"text",name:"uname"}),/*#__PURE__*/React.createElement("div",{className:`main-first-login-body-email ${loginMode?"hidden":""}`},/*#__PURE__*/React.createElement("label",{htmlFor:"email"},"Email"),/*#__PURE__*/React.createElement("input",{autoComplete:"false",className:"email",type:"email",name:"email"})),/*#__PURE__*/React.createElement("label",{htmlFor:"pass"},"Password"),/*#__PURE__*/React.createElement("input",{autoComplete:"false",className:"pass",type:"password",name:"pass"}),/*#__PURE__*/React.createElement("input",{className:"submitEntry",type:"submit",value:`${loginMode?"Login":"Register"}`}),/*#__PURE__*/React.createElement("span",{onClick:()=>{setLoginMode(!loginMode);}},"Switch to ",`${loginMode?"Register":"Login"}`,"?")))),/*#__PURE__*/React.createElement("div",{className:`main-first-game ${loggedIn?"":"hidden"}`,onClick:()=>{startGame.bind(this)(setStarted,username,setWorlds);}},/*#__PURE__*/React.createElement("img",{src:"/assets/ui/startBG.gif",alt:"startBG"}),/*#__PURE__*/React.createElement("em",{id:"startButton"},"Click the screen to start..."))),/*#__PURE__*/React.createElement("div",{className:`main-second ${started?"":"hidden"}`},/*#__PURE__*/React.createElement(WorldMenu,{worlds:worlds,setSelected:setSelected,shown:selected.length==0?true:false}),/*#__PURE__*/React.createElement("div",{className:`${selected.length==0?"hidden":""}`},/*#__PURE__*/React.createElement(Inventory,{inventory:character.inventory,profile:character.profile}))));}async function online(e,loginMode,setLoggedIn,setUsername){e.preventDefault();if(loginMode){await login.bind(this)(e,setLoggedIn,setUsername);}else {await register.bind(this)(e,setLoggedIn,setUsername);}}async function login(e,setLoggedIn,setUsername){e.preventDefault();let uname=document.querySelector("input[name=uname]");let pass=document.querySelector("input[name=pass]");let res=await fetch("/api/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uname:uname.value,pass:pass.value})});res=await res.json();if(res.success){console.log(res.user.name);setLoggedIn(true);setUsername(res.user.name);}else {status.current.innerHTML=res.message;}}async function register(e,setLoggedIn,setUsername){e.preventDefault();let uname=document.querySelector("input[name=uname]");let email=document.querySelector("input[name=email]");let pass=document.querySelector("input[name=pass]");let res=await fetch("/api/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uname:uname.value,email:email.value,pass:pass.value})});res=await res.json();if(res.success){setLoggedIn(true);setUsername(res.user.name);}else {status.current.innerHTML=res.message;}}function startGame(setStarted,username,setWorlds){setStarted(true);let game=new MainGame();MainGame.instance.onMessage=data=>{chatbox.current.chat(data);};MainGame.instance.onWorldMenu=data=>{console.log(data);let{worlds}=data;setWorlds(worlds);};game.start(username);}
