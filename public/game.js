...
class MainGame{start(){let config=new GameConfig({parent:"game",scene:[StartScene,GameScene]});BaseGame.instance.start(config);let em=new EventManager();em.setStart(game);}}

class App extends react.exports.Component{render(){return/*#__PURE__*/React.createElement("div",{className:"main"},/*#__PURE__*/React.createElement("button",{id:"startButton",onClick:()=>this.startGame()},"Start"));}startGame(){let startButton=document.getElementById("startButton");startButton.style.display="none";let game=new MainGame();game.start();}}
