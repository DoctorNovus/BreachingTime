...
function InventoryItem({item,active,setActive,slot,hotbar}){let iName="";if(!item){item={};}else if(item.id!=0){iName=BlockIndex.blocks[item.id];}return/*#__PURE__*/React.createElement("div",{className:"inventory-slot",id:slot?`slot${slot}`:hotbar?`hotbar${hotbar}`:null,onClick:()=>handleCurrent(active,setActive,item,slot,hotbar)},/*#__PURE__*/React.createElement("div",{className:`${active&&active.id&&active.id==item.id&&active.id!=0?"inv-selected":""}`}),/*#__PURE__*/React.createElement("div",{className:"inventory-item-image"},iName&&iName.trim().length>0?/*#__PURE__*/React.createElement("img",{src:`assets/blocks/${iName}.png`,alt:"slotItem"}):/*#__PURE__*/React.createElement("div",{className:"inventory-item-image-empty"})),/*#__PURE__*/React.createElement("div",{className:"inventory-item-count"},item.count&&item.count>0?/*#__PURE__*/React.createElement("span",null,item.count):/*#__PURE__*/React.createElement("span",null)));}function handleCurrent(active,setActive,item,slot,hotbar){if(slot){console.log("Selected slot");}else if(hotbar){console.log(`Selected hotbar`);}else {console.log("Selected item");}if(item&&item.id!=0)setActive({id:item.id});}

function Inventory({inventory,profile,shown}){if(!inventory)inventory=new Array(64).fill({id:0,count:0,img:""});else if(inventory.length<64){inventory=inventory.concat(new Array(64-inventory.length).fill({id:0,count:0,img:""}));}if(!profile)profile={};if(!profile.hotbar)profile.hotbar=[];if(profile.hotbar.length<9){profile.hotbar=profile.hotbar.concat(new Array(9-profile.hotbar.length).fill({id:0,count:0,img:""}));}let[active,setActive]=react.exports.useState({});return/*#__PURE__*/React.createElement("div",{className:"inv"},/*#__PURE__*/React.createElement("div",{className:`inventory ${shown?"":"hidden"}`},/*#__PURE__*/React.createElement("div",{className:"inventory-profile"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile-name"},/*#__PURE__*/React.createElement("span",null,profile.name||"No Name"),/*#__PURE__*/React.createElement("span",null,"Lvl. ",profile.level||1)),/*#__PURE__*/React.createElement("div",{className:"inventory-profile-build"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile-top"},/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.leftHand,active:active,setActive:setActive,slot:1}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.head,active:active,setActive:setActive,slot:2}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.backPiece,active:active,setActive:setActive,slot:3}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.legs,active:active,setActive:setActive,slot:4})),/*#__PURE__*/React.createElement("div",{className:"inventory-profile-center"},/*#__PURE__*/React.createElement("div",{className:"inventory-profile-center-container"},/*#__PURE__*/React.createElement(CharacterBuild,{profile:profile}))),/*#__PURE__*/React.createElement("div",{className:"inventory-profile-bottom"},/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.rightHand,active:active,setActive:setActive,slot:5}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.chest,active:active,setActive:setActive,slot:6}),/*#__PURE__*/React.createElement(InventoryItem,{item:profile.slots&&profile.slots.feet,active:active,setActive:setActive,slot:7})))),/*#__PURE__*/React.createElement("div",{className:"inventory-items"},/*#__PURE__*/React.createElement("ul",null,inventory.map((item,index)=>{return/*#__PURE__*/React.createElement("li",{key:index},/*#__PURE__*/React.createElement(InventoryItem,{item:item,active:active,setActive:setActive}));})))),/*#__PURE__*/React.createElement("div",{className:`hotbar ${shown?"":"solo"}`},profile.hotbar.map((item,index)=>{return/*#__PURE__*/React.createElement("div",{key:index},/*#__PURE__*/React.createElement(InventoryItem,{item:item,active:active,setActive:setActive,hotbar:index}));})));}

const chatbox=/*#__PURE__*/React.createRef();const status=/*#__PURE__*/React.createRef();function App(){const[loginMode,setLoginMode]=React.useState(true);const[loggedIn,setLoggedIn]=React.useState(false);const[started,setStarted]=React.useState(false);const[username,setUsername]=React.useState("");const[selected,setSelected]=React.useState("");const[worlds,setWorlds]=React.useState([]);const[character,setCharacter]=React.useState({});const[kb,setKb]=React.useState({kb:[]});return/*#__PURE__*/React.createElement("div",{className:"main"},/*#__PURE__*/React.createElement("div",{className:`main-first ${started?"hidden":""}`},/*#__PURE__*/React.createElement("div",{className:`main-first-login ${loggedIn?"hidden":""}`},/*#__PURE__*/React.createElement("div",{className:`main-first-login-body`},/*#__PURE__*/React.createElement("h1",null,`${loginMode?"Login":"Register"}`),/*#__PURE__*/React.createElement("form",{onSubmit:e=>online.bind(this)(e,loginMode,setLoggedIn,setUsername)},/*#__PURE__*/React.createElement("label",{ref:status}),/*#__PURE__*/React.createElement("label",{htmlFor:"uname"},"Username"),/*#__PURE__*/React.createElement("input",{autoComplete:"false",className:"uname",type:"text",name:"uname"}),/*#__PURE__*/React.createElement("div",{className:`main-first-login-body-email ${loginMode?"hidden":""}`},/*#__PURE__*/React.createElement("label",{htmlFor:"email"},"Email"),/*#__PURE__*/React.createElement("input",{autoComplete:"false",className:"email",type:"email",name:"email"})),/*#__PURE__*/React.createElement("label",{htmlFor:"pass"},"Password"),/*#__PURE__*/React.createElement("input",{autoComplete:"false",className:"pass",type:"password",name:"pass"}),/*#__PURE__*/React.createElement("input",{className:"submitEntry",type:"submit",value:`${loginMode?"Login":"Register"}`}),/*#__PURE__*/React.createElement("span",{onClick:()=>{setLoginMode(!loginMode);}},"Switch to ",`${loginMode?"Register":"Login"}`,"?")))),/*#__PURE__*/React.createElement("div",{className:`main-first-game ${loggedIn?"":"hidden"}`,onClick:()=>{startGame.bind(this)(setStarted,username,setSelected,setWorlds,setCharacter,kb,setKb);}},/*#__PURE__*/React.createElement("img",{src:"/assets/ui/startBG.gif",alt:"startBG"}),/*#__PURE__*/React.createElement("em",{id:"startButton"},"Click the screen to start..."))),/*#__PURE__*/React.createElement("div",{className:`main-second ${started?"":"hidden"}`},/*#__PURE__*/React.createElement(WorldMenu,{worlds:worlds,setSelected:setSelected,shown:selected.length==0?true:false}),/*#__PURE__*/React.createElement("div",{className:`${selected.length==0?"hidden":""}`},/*#__PURE__*/React.createElement(Inventory,{inventory:character.inventory,profile:character.profile,shown:kb.kb.includes("i")}))));}async function online(e,loginMode,setLoggedIn,setUsername){e.preventDefault();if(loginMode){await login.bind(this)(e,setLoggedIn,setUsername);}else {await register.bind(this)(e,setLoggedIn,setUsername);}}async function login(e,setLoggedIn,setUsername){e.preventDefault();let uname=document.querySelector("input[name=uname]");let pass=document.querySelector("input[name=pass]");let res=await fetch("/api/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uname:uname.value,pass:pass.value})});res=await res.json();if(res.success){console.log(res.user.name);setLoggedIn(true);setUsername(res.user.name);}else {status.current.innerHTML=res.message;}}async function register(e,setLoggedIn,setUsername){e.preventDefault();let uname=document.querySelector("input[name=uname]");let email=document.querySelector("input[name=email]");let pass=document.querySelector("input[name=pass]");let res=await fetch("/api/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uname:uname.value,email:email.value,pass:pass.value})});res=await res.json();if(res.success){setLoggedIn(true);setUsername(res.user.name);}else {status.current.innerHTML=res.message;}}function startGame(setStarted,username,setSelected,setWorlds,setCharacter,keybinds,setKeybindElems){setStarted(true);let game=new MainGame();MainGame.instance.onMessage=data=>{chatbox.current.chat(data);};MainGame.instance.onWorldMenu=data=>{let{worlds}=data;setWorlds(worlds);};MainGame.instance.onInventory=data=>{let{items,profile}=data;setCharacter({inventory:items,profile});};MainGame.instance.onKeybind=data=>{let kb=keybinds.kb;if(!kb.includes(data)){kb.push(data);}else {kb.splice(kb.indexOf(data),1);}setKeybindElems({kb});};MainGame.instance.setSelected=setSelected;game.start(username);}
