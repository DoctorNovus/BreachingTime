...
class ChatBox extends react.exports.Component{constructor(){super();this.state={messages:[]};}render(){return/*#__PURE__*/React.createElement("div",{className:"chatbox"},/*#__PURE__*/React.createElement("div",{className:"chatbox-header"},/*#__PURE__*/React.createElement("div",{className:"chatbox-header-title"},"Chat"),/*#__PURE__*/React.createElement("div",{className:"chatbox-header-close"},"X")),/*#__PURE__*/React.createElement("div",{className:"chatbox-body"},/*#__PURE__*/React.createElement("div",{className:"chatbox-body-messages"},this.state.messages.map((message,index)=>{return/*#__PURE__*/React.createElement("div",{className:"chatbox-body-message",key:index},/*#__PURE__*/React.createElement("div",{className:"chatbox-body-message-name"},message.name+": "),/*#__PURE__*/React.createElement("div",{className:"chatbox-body-message-text"},message.message));}))),/*#__PURE__*/React.createElement("div",{className:"chatbox-footer"},/*#__PURE__*/React.createElement("div",{className:"chatbox-footer-input"},/*#__PURE__*/React.createElement("form",{onSubmit:e=>{e.preventDefault();this.sendMessage(e.target[0].value);}},/*#__PURE__*/React.createElement("label",{htmlFor:"cb-content"},"Message: "),/*#__PURE__*/React.createElement("input",{name:"cb-content",id:"cb-content",type:"text",placeholder:"Type a message..."})))));}chat(data){this.setState({messages:[...this.state.messages,data]});}sendMessage(message){if(message.length>0){Network.instance.send({type:"chat",data:{message}});}}}
